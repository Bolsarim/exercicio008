/*
Loja de ferramentas 
Este exemplo pede o nome do usúario e três valores inteiros, os quais representam a quantidade de porcas, parafusos e arruelas compradas. Após, exibe o nome do usúario seguido da quantidade de
...
programa
{
  funcao inicio ()
  {
    // os precos dos produtos são definidos em constantes
